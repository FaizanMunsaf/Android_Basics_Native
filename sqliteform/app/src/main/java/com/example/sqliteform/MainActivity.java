...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String mail = email.getText().toString();
                int result = DB.deleteData(mail);

                Toast.makeText(MainActivity.this,result+" : Affected Row",Toast.LENGTH_SHORT).show();
            }
        });
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Boolean checkupdatedata = DB.updateDAta(name,mail,pwd,contact);
                if (checkupdatedata==true){
                    Toast.makeText(MainActivity.this,"Entry Updated",Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(MainActivity.this,"No Entry Updated",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
